...
public class Generator {
    ...
    public void mainLoop(){
        System.out.println("Welcome to Mason's Password Services :) ");
        printMenu();
    ...
    private void requestPassword(){
        ...
        final Generator generator = new Generator(IncludeUpper, IncludeUpper, IncludeNum, IncludeSym);
